...
describe('API Endpoint Testing', () => {
  ...
  it('Post booking page', (done) => {
    ...
    const dataSample = {
      ...
      firstName: 'fadzrin',
      lastName: 'madu',
      email: 'fadzrinmadu@gmail.com',
      phoneNumber: '08137171717',
      accountHolder: 'fadzrin',
      bankFrom: 'BNI',
    };
    ...
    chai.request(app).post('/api/v1/member/booking-page')
      ...
      .end((err, res) => {
        ...
        expect(res.body.booking).to.have.all.keys('payments', '_id', 'bookingStartDate', 'bookingEndDate', 'invoice', 'itemId', 'total', 'memberId', '__v');
